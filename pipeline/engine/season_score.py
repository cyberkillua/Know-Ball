...
DEFAULT_SEASON_SCORE_CONFIG = {
    ...
    "availability_floor": 60.0,
    "availability_curve": "sqrt",
}
...
def _availability_score(
    ...
    curved = math.sqrt(progress) if curve == "sqrt" else progress
...
def calculate_season_score(
    *,
    ...
    availability_floor = float(config.get("availability_floor", 60.0))
    availability_curve = str(config.get("availability_curve", "sqrt"))
