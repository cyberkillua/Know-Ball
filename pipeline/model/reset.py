...
Usage:
    python -m pipeline.model.reset                  # Clear match_ratings + peer_ratings (all leagues)
    python -m pipeline.model.reset --league 47      # Clear computed data for one league only
    python -m pipeline.model.reset --position CAM   # Clear match_ratings + peer_ratings for one position only
    python -m pipeline.model.reset --full           # Clear everything including scraped stats, matches, players, teams
"""
