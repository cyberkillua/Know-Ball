...
from pipeline.model.engine.w_calculator import calculate_winger_rating, W_CATEGORIES
from pipeline.model.engine.cam_calculator import calculate_cam_rating, CAM_CATEGORIES
from pipeline.model.engine.cm_calculator import calculate_cm_rating, CM_CATEGORIES
...
def get_unrated_records_batch(
    ...
    return db.query(
        ...
        SELECT mps.id,
               ...
               mps.accurate_own_half_passes,
               mps.total_own_half_passes,
               mps.accurate_opposition_half_passes,
               mps.total_opposition_half_passes,
...
def rate_record(
    ...
    stats = PlayerMatchStats(
        ...
        accurate_own_half_passes=record.get("accurate_own_half_passes") or 0,
        total_own_half_passes=record.get("total_own_half_passes") or 0,
        accurate_opposition_half_passes=record.get("accurate_opposition_half_passes") or 0,
        total_opposition_half_passes=record.get("total_opposition_half_passes") or 0,
        accurate_long_balls=record.get("accurate_long_balls") or 0,
        total_long_balls=record.get("total_long_balls") or 0,
